...
# import the namespace module of the emotion.py

# get the address of dictionary from the audioanalysis and import function namespace
dictStr = os.popen('bash -c "python audioAnalysis.py classifyFolder -i /mnt/e/test5/ --model svm --classifier models/svmGenreRecog ''--details | tee /dev/stderr | grep {*}"').read()

# evaluate the expression containing literal 
